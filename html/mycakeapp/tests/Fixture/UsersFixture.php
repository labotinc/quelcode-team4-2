...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sex' => ['type' => 'string', 'length' => 1, 'fixed' => true, 'null' => false, 'default' => '0', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'sex' => 'L',
                'is_deleted' => 1,
                'created' => '2020-11-06 10:52:16',
                'modified' => '2020-11-06 10:52:16',
            ],
        ];
        parent::init();
    }
