...
class BookingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'seat_number' => ['type' => 'string', 'length' => 2, 'fixed' => true, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'seat_number' => 'Lo',
                'is_cancelled' => 1,
                'created' => '2020-11-13 10:59:57',
                'modified' => '2020-11-13 10:59:57',
            ],
        ];
        parent::init();
    }
