let modal_cancel = () => {
     ...
     */
    $("[id=cancel-submit-main]").on("click", () => {
        $("form")[0].submit();
        return false;
    });

    $("[id=cancel-send-temporary]").on("click", () => {
     ...
     * モーダルの削除ボタン押下時フォームを送信する
     */
    $("[id=cancel-submit-temporary]").on("click", () => {
        $("form")[0].submit();
        return false;
    });
};
...
modalContentsMain +=
    '<p class="modal__text">本当にこの予約をキャンセルしますか？</p>';
modalContentsMain +=
    '<button class="js-modal-close-main link-button__middle-modal" href="">戻る</button>';
modalContentsMain +=
    '<button class="link-button__small-modal" id="cancel-submit-main" name="cancel-submit-main">予約キャンセル</button>';
modalContentsMain += "</div></div>";

let modalContentsTemporary = '<div class="modal js-modal-temporary">';
modalContentsTemporary +=
    '<div class="modal__bg js-modal-close-temporary"></div>';
modalContentsTemporary += '<div class="modal__content">';
modalContentsTemporary +=
    '<p class="modal__text">本当にこの予約をキャンセルしますか？</p>';
modalContentsTemporary +=
    '<button class="js-modal-close-temporary link-button__middle-modal" href="">戻る</button>';
modalContentsTemporary +=
    '<button class="link-button__small-modal" id="cancel-submit-temporary" name="cancel-submit-temporary">予約キャンセル</button>';
